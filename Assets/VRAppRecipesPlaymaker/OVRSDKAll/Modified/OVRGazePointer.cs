...
public class OVRGazePointer : MonoBehaviour {
	...
	void Start()
	{
		rayTransform = cameraRig.centerEyeAnchor.transform;
	}
	...
	public bool alignPointerRotation = true;
    ...
    public void SetPosition(Vector3 pos, Vector3 normal)
    {
        ...
        if (alignPointerRotation) newRot.SetLookRotation(normal, rayTransform.up);
		else newRot.SetLookRotation(rayTransform.forward, rayTransform.up);
