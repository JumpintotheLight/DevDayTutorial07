...
public class JSON {
	...
	public static Hashtable JsonDecode(string json) {
		bool success = true;
		return JsonDecode(json, 0, ref success) as Hashtable;
	}
	...
	public static object JsonDecode(string json, int startindex, ref bool success) {
		success = true;
		if (json != null) {
			char[] charArray = json.ToCharArray();
            int index = startindex;
			return ParseValue(LookAhead(charArray, ref index), charArray, ref index, ref success);
        } else
            return null;
	}
