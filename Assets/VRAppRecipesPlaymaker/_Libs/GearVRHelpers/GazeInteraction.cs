...
public class GazeInteraction : MonoBehaviour {
    private GazeInteractionInputModule gazeInputModule;
	
    private float newGazeInteractionDelay = 0;

	void Awake()
	{
		gazeInputModule = FindObjectOfType<GazeInteractionInputModule> ();
		if (gazeInputModule==null) Debug.LogError ("GazeInteractionInputModule not found");
	}
